const CACHE = 'duofinance-v27';
const ASSETS = ['/', '/login', '/css/style.css?v=27', '/js/app.js?v=27', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
