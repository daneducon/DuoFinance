const CACHE = 'duofinance-v28';
const ASSETS = ['/', '/login', '/css/style.css?v=28', '/js/app.js?v=28', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
