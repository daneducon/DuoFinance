const CACHE = 'duofinance-v29';
const ASSETS = ['/', '/login', '/css/style.css?v=29', '/js/app.js?v=29', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
