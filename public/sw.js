const CACHE = 'duofinance-v22';
const ASSETS = ['/', '/login', '/css/style.css?v=22', '/js/app.js?v=22', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
