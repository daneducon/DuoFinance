const CACHE = 'duofinance-v32';
const ASSETS = ['/', '/login', '/css/style.css?v=32', '/js/app.js?v=32', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
