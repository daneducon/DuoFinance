const CACHE = 'duofinance-v24';
const ASSETS = ['/', '/login', '/css/style.css?v=24', '/js/app.js?v=24', '/js/login.js?v=19', '/js/auth.js', '/js/api.js', '/js/demo.js', '/js/storage.js', '/assets/icon.svg', '/manifest.json'];
