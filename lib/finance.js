...
function billSituation(month, status, referenceMonth = currentMonth()) {
  ...
  if (month === referenceMonth) return 'Aberta';
  return status === 'Pago' ? 'Paga' : 'Pendente';
}

module.exports = { normalizeTransaction, toSheetRow, validateTransaction, validateBox, summarize, calculateCashFlow, buildAnalysis, parseMoney, billSituation, currentMonth };
