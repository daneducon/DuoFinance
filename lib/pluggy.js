...
function createConnectToken(clientUserId, itemId) {
  return request('/connect_token', {
    method: 'POST',
    body: JSON.stringify({
      ...(itemId ? { itemId } : {}),
...
module.exports = { createConnectToken, getItem, listAccounts, listTransactions, mapTransaction, cardName };
